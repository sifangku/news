...
<body>
	...
	<div class="container" style="margin-top:50px;">
		<form class="form-horizontal" action="<?php echo Url::getUrl(array('m'=>'register'))?>" method="post">
		  ...
		  <div class="form-group">
			<label for="input3" class="col-sm-2 control-label">密码确认</label>
			<div class="col-sm-10">
			  <input type="password" name="password1" class="form-control" id="input3" placeholder="密码确认">
			</div>
		  </div>
		  <div class="form-group">
