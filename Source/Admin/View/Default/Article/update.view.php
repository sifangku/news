			  ...
			  <div class="panel-body">
				  	<form id="add-type" class="form-horizontal" method="post">
						    ...
						    <div class="col-md-9">
							    <select name="atid" class="form-control" id="input0">
								  ...
								  foreach ($this->getData('arctype') as $val){
									if($val['id']==$this->getData('article')['atid']){
										$selected='selected=selected';
									}else{
										$selected='';
									}
								  	echo "<option {$selected} value='{$val['id']}'>{$val['style']}{$val['name']}</option>";
								  }
								  ?>
								</select>
						    </div>
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="title" type="text" class="form-control" id="input1" placeholder="新闻标题" value="<?php echo $this->getData('article')['title']?>">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
							    <script id="container" name="content" type="text/plain"><?php echo $this->getData('article')['content']?></script>
								<script type="text/javascript">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-8">
						      <input name="litpic" type="text" class="form-control" id="input3" placeholder="缩略图"  value="<?php echo $this->getData('article')['litpic']?>">
						    </div>
						    <div class="col-md-1">
						    ...
						    <div class="col-md-9">
						      <input name="keywords" type="text" class="form-control" id="input4" placeholder="关键字" value="<?php echo $this->getData('article')['keywords']?>">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						    	<textarea name="description" class="form-control" id="input5" rows="3" placeholder="SEO描述"><?php echo $this->getData('article')['description']?></textarea>
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="weights" type="text" class="form-control" id="input6" placeholder="权重" value="<?php echo $this->getData('article')['weights']?>">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
							    <label class="checkbox-inline">
								  <input <?php if(in_array('h',$this->getData('article')['flag'])) echo 'checked=checked'?> name="flag[]" type="checkbox" value="h"> 头条
								</label>
								<label class="checkbox-inline">
								  <input <?php if(in_array('a',$this->getData('article')['flag'])) echo 'checked=checked'?> name="flag[]" type="checkbox" value="a"> 特别推荐
								</label>
								<label class="checkbox-inline">
								  <input <?php if(in_array('c',$this->getData('article')['flag'])) echo 'checked=checked'?> name="flag[]" type="checkbox" value="c"> 推荐
								</label>
						    </div>
						    <div class="col-md-2">
