			  ...
			  <div class="panel-body">
				  	<form id="add-type" class="form-horizontal" method="post">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="name" type="text" class="form-control" id="input1" placeholder="栏目名称">
						    </div>
						    <div class="col-md-2">
						    ...
						    <div class="col-md-9">
						      <input name="uname" type="text" class="form-control" id="input2" placeholder="URL目录">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="view" type="text" class="form-control" id="input3" placeholder="栏目界面">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="title" type="text" class="form-control" id="input4" placeholder="SEO标题">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="keywords" type="text" class="form-control" id="input5" placeholder="SEO关键字">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						    	<textarea name="description" class="form-control" id="input6" rows="3" placeholder="SEO描述"></textarea>
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="sort" type="text" class="form-control" id="input7" value="999" placeholder="排序">
						    </div>
						    <div class="col-md-2">
