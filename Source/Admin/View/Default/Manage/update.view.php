			  ...
			  <div class="panel-body">
				  	<form id="add-type" class="form-horizontal" method="post">
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input disabled="disabled" name="name" type="text" class="form-control" id="input1" placeholder="管理员名称" value="<?php echo $this->getData('manage')['name']?>">
						    </div>
						    <div class="col-md-2">
						    ...
						    <div class="col-md-9">
						      <input disabled="disabled" name="pname" type="text" class="form-control" id="input2" placeholder="笔名" value="<?php echo $this->getData('manage')['pname']?>">
						    </div>
						    <div class="col-md-2">
						  ...
						  <div class="form-group row">
						    ...
						    <div class="col-md-9">
						      <input name="password" type="text" class="form-control" id="input3" placeholder="不修改则留空">
						    </div>
						    <div class="col-md-2">
						    	...
						    	?>
								  ...
								  <div class="panel-body">
								    ...
								    foreach ($controller as $method){
										if(Power::has($this->getData('manage')['power'],$method['pmark'])){
								    ...
								    <label class="checkbox-inline">
									  <input <?php echo $checked?> name="power[]" type="checkbox" value="<?php echo $method['pmark']?>"> <?php echo $method['note']?>
									</label>
									<?php 
									}
									?>
